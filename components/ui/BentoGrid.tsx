...
export const BentoGridItem = ({
  ...
  const leftLists = ["GraphQL", "Shopify", "Liquid"];
  ...
  const handleCopy = () => {
    const text = "nandaniyakhushal@gmail.com";
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 1 && (
            <a href="/khushal-resume.pdf" download>
     ...
     bg-slate-950 px-7 text-sm font-medium text-white backdrop-blur-3xl gap-2`}
          ...
          {/* Tech stack list div */}
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute right-3 top-0">
              {/* tech stack lists */}
